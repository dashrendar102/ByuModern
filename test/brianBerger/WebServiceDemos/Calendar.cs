...
namespace WebServiceDemos
{
    public class Calendar
    {
        ...
        public Calendar(string name, string description) {
            this.TimeZone = NodaTime.DateTimeZoneProviders.Tzdb.GetZoneOrNull("America/Denver");
            this.Name = name;
        ...
        public void AddCourse(CourseInfo course)
        {
            ...
            courseDates.StartDate = new LocalDate(2014, 1, 6);
            courseDates.EndDate = new LocalDate(2014, 4, 23);
